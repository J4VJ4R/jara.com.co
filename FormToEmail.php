...
if(!$set){$errors[] = "Debes llenar todos los campos del formulario";}
...
<b>Gracias <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?></b>

<br>Tu mensaje ha sido enviado con éxito y pronto nos pondremos en contacto

<p><a href="<?php print $continue; ?>">Click aquí para continuar</a></p>
